namespace Ninject.SpecFlowPlugin.Acceptance.TestClasses
{
    ...
    public sealed class SingletonDisposableFeatureDependency1 : ISingletonDisposableFeatureDependency1
    {
        private readonly TestThreadContext testThreadContext;

        public SingletonDisposableFeatureDependency1(TestThreadContext testThreadContext)
        {
